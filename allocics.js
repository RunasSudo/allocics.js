...
(function() {
	...
	var cal = [['BEGIN', 'VCALENDAR'], ['VERSION', '2.0'], ['PRODID', '-//RunasSudo//allocics.js//EN']];
	...
	// Download it!
	var blob = new Blob([calStr], {type: 'text/calendar;charset=utf-8'});
